...
- confidence: cited
  path: crates/eventlog-file/tests/adversary_strict_inspection.rs
- confidence: cited
...
- confidence: cited
  path: crates/eventlog-sqlite/tests/adversary_strict_inspection.rs
- confidence: cited
...
executing artifact while avoiding the later unlinked path; runner-review.md records
